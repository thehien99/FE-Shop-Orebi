  ...
  return (
    <div className='mx-6 p-6 xs:hidden'>
      <div className='relative '>
        ...
        <div className='absolute mbl:hidden top-[20%] xs:right-0 xs:p-6 xs:rounded-lg xs:gap-5 xs:top-0 xs:z-10 lg:top-[7%] right-24 flex flex-col  gap-6 lg:gap-5 md:gap-3 w-[38%] xs:bg-[#cccc] xs:w-full'>
          ...
          <NavLink to={`/${Router.shop}`} className='border w-1/3 p-4 lg:p-1 md:p-2 md:text-sm xs:w-full xs:p-3 text-xl bg-black text-white font-bold rounded-md'>Shop now</NavLink>
        </div>
      </div>
    </div>
  )
